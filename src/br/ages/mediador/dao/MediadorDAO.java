...
public class MediadorDAO {
	...
	public int cadastrarMediador(Mediador mediador) throws ClassNotFoundException, PersistenciaException, SQLException {
		...
		try {
			...
			sql.append(
					"insert into tb_mediador(id_mediador, cpf, matricula, nome, email, tipo_mediador, status_mediador, data_cadastro)");
			sql.append("values(?, ?, ?, ?, ?, ?, ?, ?)");
	...
	public Mediador pesquisarMediadorPorId(int id) throws PersistenciaException, SQLException, ParseException {
		Connection conexao = null;
		Mediador med = new Mediador();
